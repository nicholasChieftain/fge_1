    ...
    for i=variables.kkntau_for_check + 2:variables.l_T
        ...
        variables.ux_for_check = evalfis(variables.fis_of_x_for_check, ...
                              [variables.ex_for_check, variables.dex_for_check], ...
                               variables.opt);
        fprintf('Without fis_x generated by anfis: %f\n', variables.ux_for_check);
        variables.ux_for_check = evalfis(outFIS_x, variables.ux_for_check, variables.opt);                
        fprintf('With fis_x generated by anfis: %f\n', variables.ux_for_check);
        ...
        variables.uy_for_check = evalfis(outFIS_y, variables.uy_for_check, variables.opt);   
